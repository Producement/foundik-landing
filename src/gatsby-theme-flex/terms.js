  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Foundik OÜ ("Company", “we”, “us”, or “our”), concerning your access to and use of the <a href='https://foundik.com'>https://foundik.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
        ...
        <p>
          ...
          will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a 
          
          username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise 
        ...
        <p>This can be paid securely through <a href="http://www.maksekeskus.ee/">Maksekeskus AS</a> payment gateway.</p>
        ...
        <p>
          ...
          If you are unsatisfied with our services, please email us at <a href="mailto:hello@foundik.com">hello@foundik.com</a>.
        </p>
        ...
        <p>These conditions are governed by and interpreted following the laws of Estonia, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Foundik O&Uuml; and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Tallinn, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in Estonia, or in the EU country in which you reside.</p>
        ...
        <p><i>Foundik OÜ</i></p>
        <p><i>Pärnu mnt 20a</i></p>
        <p><i>Tallinn 10141</i></p>
        <p><i>Estonia</i></p>
        <p><i><a href='mailto:hello@foundik.com'>hello@foundik.com</a></i></p>
      </Container>
    </section>
  )
}